...
class RedmineConnector(BaseConnector):
    ...
    def _save_ticket_container(self, action_result, ticket):
        """
        Save a ticket retrieved from redmine to it's phantom container.
    ...
    def _update_ticket_container(self, container_id, ticket):
        # Updates a given phantom container with a ticket
    ...
    def _create_ticket_artifacts(self, ticket, container_id):
        ...
        ticket_artifact = {
            ...
            "name": ticket[REDMINE_TICKET_JSON_ID],
    ...
    def _handle_create_ticket(self, param):
        ...
        try:
            ...
            return action_result.set_status(
                phantom.APP_ERROR, "Could not parse custom fields"
            )
    ...
    def _handle_list_tickets(self, param):
        ...
        start_index = param.get("start_index", "")
    ...
    def _handle_get_ticket(self, param):
        ...
        # make rest call
        ret_val, response = self._make_rest_call(
            "/issues.json", action_result, params=params, headers=None
        )
    ...
    def _handle_list_projects(self, param):
        ...
        # make rest call
        ret_val, response = self._make_rest_call(
            "/projects.json", action_result, params=None, headers=None
        )
        ...
        if phantom.is_fail(ret_val):
            ...
            # for now the return is commented out, but after implementation, return from here
            return action_result.get_status(
                phantom.APP_ERROR, "Could not retrieve projects"
            )
