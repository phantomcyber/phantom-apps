...
class SixgillOnPollConnector(object):
    ...
    def on_poll(self, param):
            ...
            for indicator in indicator_object:
                if sixgill.sixgill_utils.is_indicator(indicator):
                    ...
                    if feed_dict:
                        ...
                        if container_status == self._connector.phantom.APP_SUCCESS:
                            ...
                            self._connector.action_result.ActionResult.set_status = True
                        else:
                            # Return error status if the indicator didn't get ingested
                            action_result.set_status(phantom.APP_ERROR)
                            self._connector.action_result.ActionResult.set_status = False
        else:
        ...
        return self._connector.action_result.ActionResult.get_status
