...
SMIME_SIGN_ERR_MSG = "Error occurred while signing message. Error: {err}"
...
SMIME_VERIFY_ERR_MSG = "Error occurred while verifying message. Error: {err}"
...
SMIME_ENCRYPT_ERR_MSG = "Error occurred while encrypting message. Error: {err}"

# Decrypt email action related constants
SMIME_DECRYPT_PROGRESS_MSG = "Decrypting encrypted email message"
SMIME_DECRYPT_ERR_MSG = "Error occurred while decrypting message. Error: {err}"
