...
# Copyright SentinelOne 2018-2019
#
...
class SentineloneConnector(BaseConnector):
    ...
    def _make_rest_call(self, endpoint, action_result, headers=None, params=None, data=None, method='get'):
        ...
        url = self._base_url.encode('utf-8') + str(endpoint)
    ...
    def _handle_test_connectivity(self, param):
        ...
        ret_val, response = self._make_rest_call('/web/api/v2.0/private/threats/summary', action_result, headers=headers)
    ...
    def _get_site_ids(self, sites_tokens, headers, action_result):
        site_ids = []
        try:
            for site in sites_tokens:
                ret = requests.get(self._base_url + '/web/api/v2.0/sites?registrationToken=' + site, headers=headers)
    ...
    def _handle_block_hash(self, param):
        ...
        sites = param['sites_tokens']
        sites_tokens = sites.split(',')
        ...
        site_ids = self._get_site_ids(sites_tokens, headers, action_result)
        ...
        try:
            ret_val, response = self._make_rest_call('/web/api/v2.0/restrictions', action_result, headers=headers, method='post', data=body)
            if (phantom.is_fail(ret_val)):
                return action_result.get_status()
        except Exception as e:
    ...
    def _handle_unblock_hash(self, param):
        ...
        for site_id in site_ids:
            ...
            try:
                ret = requests.get(self._base_url + "/web/api/v2.0/restrictions", headers=headers, params=params)
            except Exception as e:
                return action_result.set_status(phantom.APP_ERROR, "Error occurred while getting restrictions : {0}".format(e))
        ...
        try:
            ret_val, response = self._make_rest_call('/web/api/v2.0/restrictions', action_result, headers=headers, method='delete', data=body)
            if (phantom.is_fail(ret_val)):
                return action_result.get_status()
        except Exception as e:
    ...
    def _handle_quarantine_device(self, param):
        ...
        if (ret_val == '0'):
            ...
            try:
                ret_val, response = self._make_rest_call('/web/api/v2.0/agents/actions/disconnect', action_result, headers=headers, method='post', data=body)
                if (phantom.is_fail(ret_val)):
                    return action_result.get_status()
            except Exception as e:
    ...
    def _handle_unquarantine_device(self, param):
        ...
        if (ret_val == '0'):
            ...
            try:
                ret_val, response = self._make_rest_call('/web/api/v2.0/agents/actions/connect', action_result, headers=headers, method='post', data=body)
                if (phantom.is_fail(ret_val)):
                    return action_result.get_status()
            except Exception as e:
    ...
    def _handle_scan_endpoint(self, param):
        ...
        if ret_val == '0':
            ...
            try:
                ret_val, response = self._make_rest_call('/web/api/v2.0/agents/actions/initiate-scan', action_result, headers=headers, method='post', data=body)
                if (phantom.is_fail(ret_val)):
                    return action_result.get_status()
            except Exception as e:
    ...
    def _handle_get_endpoint_info(self, param):
        ...
        if ret_val == '0':
            ...
            headers["Authorization"] = "APIToken %s" % self.token
            try:
                ret_val, response = self._make_rest_call('/web/api/v2.0/agents?ids=' + ret_val, action_result, headers=headers)
                if (phantom.is_fail(ret_val)):
                    return action_result.get_status()
    ...
    def _handle_mitigate_threat(self, param):
        ...
        # POST /web/api/v2.0/threats/mitigate/:action
        try:
            ret_val, response = self._make_rest_call('/web/api/v2.0/threats/mitigate/' + action, action_result, headers=headers, method='post', data=body)
            if (phantom.is_fail(ret_val)):
                return action_result.get_status()
        except Exception as e:
    ...
    def _get_agent_id(self, search_text, action_result):
        ...
        headers = self.HEADER
        headers["Authorization"] = "APIToken %s" % self.token
        ret_val, response = self._make_rest_call('/web/api/v2.0/agents?query=' + search_text, action_result, headers=headers)
