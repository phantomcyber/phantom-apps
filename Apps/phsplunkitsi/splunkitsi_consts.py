...
TYPE_ERR_MSG = "Error occurred while connecting to the Splunk IT Service Intelligence Server. Please check the asset configuration and|or the action parameters"
