...
class BitglassConnector(BaseConnector):
    ...
    def _handle_test_connectivity(self, param):
        ...
        ret_val, response = self._make_rest_call(
            '/region', action_result, params=None, headers=None
        )
    ...
    def _handle_analyze_new_logs(self, param):
        # Implement the handler here
        # use self.save_progress(...) to send progress messages back to the platform
        self.save_progress("In action handler for: {0}".format(self.get_action_identifier()))
        ...
        # make rest call
        ret_val, response = self._make_rest_call(
            '/api/bitglassapi', action_result, params=None, headers=None
        )
    ...
    def _handle_add_user_to_risk_group(self, param):
        # Implement the handler here
        # use self.save_progress(...) to send progress messages back to the platform
        self.save_progress("In action handler for: {0}".format(self.get_action_identifier()))
    ...
    def handle_action(self, param):
        ...
        elif action_id == 'analyze_new_logs':
            ret_val = self._handle_analyze_new_logs(param)

        elif action_id == 'add_user_to_risk_group':
            ret_val = self._handle_add_user_to_risk_group(param)
