# File: mcafeewebgateway_consts.py
#
...
TYPE_ERR_MSG = "Error occurred while connecting to the McAfee Web Gateway Server. Please check the asset configuration and|or the action parameters"
