...
AWSIAM_ERR_BOTO3_CLIENT_NOT_CREATED = "iCould not create boto3 client: {err}"
AWSIAM_ERR_INVALID_METHOD = "Invalid method: {method}"
AWSIAM_ERR_BOTO3_CALL_FAILED = "Boto3 call to IAM failed: {err}"
AWSIAM_ERR_CODE_UNAVAILABLE = "Error code unavailable"
AWSIAM_ERR_MSG_UNAVAILABLE = "Error message unavailable. Please check the asset configuration and|or action parameters."
AWSIAM_PARSE_ERR_MSG = "Unable to parse the error message. Please check the asset configuration and|or action parameters."
