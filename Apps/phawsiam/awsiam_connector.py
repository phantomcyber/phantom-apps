...
class AwsIamConnector(BaseConnector):
    ...
    def _process_empty_response(response, action_result):
        ...
        if response.status_code == 200:
            return RetVal(status.APP_SUCCESS, {})

        return RetVal(action_result.set_status(status.APP_ERROR, "Empty response and no information in the header"),
                      None)
    ...
    def _process_xml_response(response, action_result):
        ...
        if 200 <= response.status_code < 399:
            return RetVal(status.APP_SUCCESS, text)
        ...
        return RetVal(action_result.set_status(status.APP_ERROR, message), text)
    ...
    def _process_html_response(response, action_result):
        ...
        return RetVal(action_result.set_status(status.APP_ERROR, message), None)
    ...
    def _process_json_response(response, action_result):
        ...
        try:
            ...
            return RetVal(action_result.set_status(status.APP_ERROR, "Unable to parse JSON response. Error: {0}".
                                                   format(str(e))), None)

        # Please specify the status codes here
        if 200 <= response.status_code < 399:
            return RetVal(status.APP_SUCCESS, resp_json)
    ...
    def _make_rest_call(self, action_result, params=None, data=None, method='get', timeout=None):
        ...
        try:
            ...
            return RetVal(action_result.set_status(status.APP_ERROR, AWSIAM_CONFIG_PARAMS_ENCODING_ERROR_MSG),
                          resp_json)
        ...
        try:
            ...
            return RetVal(action_result.set_status(status.APP_ERROR, "Invalid method: {0}".format(method)), resp_json)
        ...
        try:
            ...
            return RetVal(action_result.set_status(status.APP_ERROR, "Error Connecting to server. Details: {0}".
    ...
    def _handle_disable_user(self, param):
        ...
        return action_result.set_status(status.APP_SUCCESS, AWSIAM_USER_DISABLED_MSG.format(username=username))
    ...
    def _handle_enable_user(self, param):
        ...
        return action_result.set_status(status.APP_SUCCESS, AWSIAM_USER_ENABLED_MSG.format(username=username))
    ...
    def _handle_assign_policy(self, param):
        ...
        return action_result.set_status(status.APP_SUCCESS, AWSIAM_ATTACH_USER_POLICY_MSG.
    ...
    def _handle_remove_policy(self, param):
        ...
        return action_result.set_status(status.APP_SUCCESS, AWSIAM_DETACH_USER_POLICY_MSG.
                                        format(policy_arn=policy_arn, username=username))
    ...
    def _handle_detach_policy(self, param):
        ...
        if not role_exist:
            return action_result.set_status(status.APP_ERROR, AWSIAM_ROLE_DOES_NOT_EXIST_MSG.
        ...
        return action_result.set_status(status.APP_SUCCESS, AWSIAM_DETACH_ROLE_POLICY_MSG.
    ...
    def _handle_attach_policy(self, param):
        ...
        return action_result.set_status(status.APP_SUCCESS, AWSIAM_ATTACH_ROLE_POLICY_MSG.
                                        format(policy_arn=policy_arn, role_name=role_name))
    ...
    def _handle_remove_role(self, param):
        ...
        if not role_exist:
            return action_result.set_status(status.APP_SUCCESS, AWSIAM_NO_NEED_TO_REMOVE_ROLE_MSG.
        ...
        return action_result.set_status(status.APP_SUCCESS, AWSIAM_ROLE_DELETED_MSG.format(role_name=role_name))
    ...
    def _handle_add_role(self, param):
        ...
        try:
            ...
            return action_result.set_status(status.APP_ERROR, AWSIAM_POLICY_DOC_TRIMMING_ERROR_MSG)
        ...
        if role_exist and role_instance_profile_exist:
            return action_result.set_status(status.APP_ERROR, AWSIAM_ROLE_AND_PROFILE_ALREADY_EXISTS_MSG.
                                            format(role_name=role_name))
        elif role_exist:
            return action_result.set_status(status.APP_ERROR, AWSIAM_ROLE_ALREADY_EXISTS_MSG.
                                            format(role_name=role_name))
        elif role_instance_profile_exist:
            return action_result.set_status(status.APP_ERROR, AWSIAM_ROLE_INSTANCE_PROFILE_ALREADY_EXISTS_MSG.
                                            format(role_name=role_name))

        # Check if role_path is given in correct format
        if not role_path == '/' and (not role_path.startswith('/') or not role_path.endswith('/')):
            return action_result.set_status(status.APP_ERROR, AWSIAM_INVALID_ROLE_PATH_MSG)
        ...
        return action_result.set_status(status.APP_SUCCESS, AWSIAM_ADD_ROLE_MSG.format(role_name=role_name))
    ...
    def _handle_delete_user(self, param):
        ...
        return action_result.set_status(status.APP_SUCCESS, AWSIAM_USER_DELETED_MSG.format(username=username))
    ...
    def _handle_remove_user(self, param):
        ...
        return action_result.set_status(status.APP_SUCCESS, AWSIAM_USER_REMOVED_FROM_GROUP_MSG.
    ...
    def _handle_add_user(self, param):
        ...
        return action_result.set_status(status.APP_SUCCESS, AWSIAM_USER_ADDED_TO_GROUP_MSG.
                                        format(username=username, group_name=group_name))
    ...
    def _handle_list_groups(self, param):
        ...
        if group_path and not group_path == '/' and (not group_path.startswith('/') or not group_path.endswith('/')):
            return action_result.set_status(status.APP_ERROR, AWSIAM_INVALID_GROUP_PATH_MSG)
    ...
    def _handle_list_users(self, param):
        ...
        if user_path and not user_path == '/' and (not user_path.startswith('/') or not user_path.endswith('/')):
            return action_result.set_status(status.APP_ERROR, AWSIAM_INVALID_USER_PATH_MSG)
    ...
    def initialize(self):
        ...
        extra initialization of any internal modules. This function MUST return a value of either status.APP_SUCCESS.
        """
